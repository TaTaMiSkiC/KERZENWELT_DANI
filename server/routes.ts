        ...
        return res.json({
          titleText: {
            de: [
              "Willkommen",
              "Kerzenwelt by Dani",
              "Wo Kerzen Wärme und Stil vereinen",
            ],
            hr: [
              "Dobrodošli",
              "Svijet svijeća by Dani",
              "Gdje se toplina i stil spajaju",
            ],
            en: [
              "Welcome",
              "The Candle World by Dani",
              "Where warmth and style unite",
            ],
            it: [
              "Benvenuti",
              "Il mondo delle candele di Dani",
              "Dove calore e stile si incontrano",
            ],
            sl: [
              "Dobrodošli",
              "Svet sveč by Dani",
              "Kjer se toplina in stil združita",
            ],
          },
          subtitleText: {
