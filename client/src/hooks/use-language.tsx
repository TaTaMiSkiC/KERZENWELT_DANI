...
export const translations: Record<Language, Record<string, string>> = {
  de: {
    ...
    "products.noProductspokusajdrugacije":
    ...
    "checkout.tax": "MwSt.",
    "checkout.saveAddress": "Adresse für zukünftige Bestellungen speichern",
    "checkout.sameAsBilling": "Lieferadresse = Rechnungsadresse",
    "checkout.shippingAddress": "Lieferadresse",
    "checkout.requiredField": "Pflichtfeld",
    "checkout.invalidEmail": "Ungültige E-Mail-Adresse",
    "checkout.invalidPhone": "Ungültige Telefonnummer",
    "checkout.orderSuccess": "Bestellung erfolgreich aufgegeben!",
    "checkout.orderError": "Fehler beim Aufgeben der Bestellung",
    ...
    "checkout.expiryDate": "Gültigkeitsdatum",
    "checkout.cvv": "CVV",
    ...
    "orderSuccessPage.paymentMethodStripe": "Kreditkarte (Stripe)",
    "orderSuccessPage.paymentMethodPaypal": "PayPal",
    "orderSuccessPage.paymentMethodPickup": "Abholung im Geschäft",
    "orderSuccessPage.statusPending": "Status: Ausstehend",
    "orderSuccessPage.statusCompleted": "Status: Abgeschlossen",
    "orderSuccessPage.orderDetails": "Bestelldetails",
    "orderSuccessPage.orderDate": "Bestelldatum",
    "orderSuccessPage.orderedItems": "Bestellte Artikel",
  ...
  hr: {
    ...
    "checkout.lastName": "Prezime",
    "checkout.email": "Email adresa",
    "checkout.phone": "Broj telefona",
    "checkout.billingAddress": "Adresa za naplatu",
    "checkout.address": "Ulica i broj",
    "checkout.city": "Grad",
    "checkout.postalCode": "Poštanski broj",
    "checkout.country": "Zemlja",
    "checkout.paymentMethod": "Način plaćanja",
    "checkout.selectPaymentMethod": "Odaberite način plaćanja",
    "checkout.orderNotes": "Napomene uz narudžbu",
    "checkout.orderNotesPlaceholder": "Posebni zahtjevi ili napomene...",
    "checkout.placeOrder": "Potvrdite narudžbu",
    "checkout.processing": "Obrađuje se...",
    "checkout.orderTotal": "Ukupno za plaćanje",
    "checkout.subtotal": "Međuzbroj",
    "checkout.shipping": "Troškovi dostave",
    "checkout.freeShipping": "Besplatna dostava",
    "checkout.total": "Ukupno",
    "checkout.tax": "PDV",
    "checkout.saveAddress": "Spremi adresu za buduće narudžbe",
    "checkout.sameAsBilling": "Adresa dostave = adresa naplate",
    "checkout.shippingAddress": "Adresa dostave",
    "checkout.requiredField": "Obavezno polje",
    "checkout.invalidEmail": "Neispravna email adresa",
    "checkout.invalidPhone": "Neispravan broj telefona",
    "checkout.orderSuccess": "Narudžba je uspješno poslana!",
    "checkout.orderError": "Greška prilikom slanja narudžbe",
    "checkout.paymentFailed": "Plaćanje neuspješno",
    "checkout.paymentSuccessful": "Plaćanje uspješno",
    "checkout.cardNumber": "Broj kartice",
    "checkout.expiryDate": "Datum isteka",
    "checkout.cvv": "CVV",
    "checkout.cardholderName": "Ime vlasnika kartice",
    "checkout.firstNameRequired": "Ime je obavezno",
    "checkout.lastNameRequired": "Prezime je obavezno",
    "checkout.phoneRequired": "Broj telefona je obavezan",
    "checkout.addressRequired": "Adresa je obavezna",
    ...
    "products.noProductspokusajdrugacije":
      "Pokušajte s drugačijim filterima ili pogledajte sve proizvode",
    "products.tryDifferentFilters":
    ...
    // Order Success Page Stripe translations - Croatian
    "orderSuccessPage.title": "Potvrda narudžbe",
    "orderSuccessPage.loadingOrder": "Učitavanje narudžbe...",
    ...
    "orderSuccessPage.paymentMethodStripe": "Kreditna kartica (Stripe)",
    "orderSuccessPage.paymentMethodPaypal": "PayPal",
    "orderSuccessPage.paymentMethodPickup": "Preuzimanje u trgovini",
    "orderSuccessPage.statusPending": "Status: Na čekanju",
    "orderSuccessPage.statusCompleted": "Status: Završeno",
    "orderSuccessPage.orderDetails": "Detalji narudžbe",
    "orderSuccessPage.orderDate": "Datum narudžbe",
    "orderSuccessPage.orderedItems": "Naručeni artikli",
  ...
  en: {
    ...
    "checkout.orderNotesPlaceholder": "Special requests or notes...",
    ...
    "checkout.tax": "Tax",
    "checkout.saveAddress": "Save address for future orders",
    "checkout.sameAsBilling": "Shipping address = billing address",
    ...
    "checkout.orderError": "Error placing order",
    ...
    // Order Success Page Stripe translations - English
    "orderSuccessPage.title": "Order Confirmation",
    "orderSuccessPage.loadingOrder": "Loading order...",
    ...
    "orderSuccessPage.paymentMethodStripe": "Credit Card (Stripe)",
    "orderSuccessPage.paymentMethodPaypal": "PayPal",
    "orderSuccessPage.paymentMethodPickup": "Store Pickup",
    "orderSuccessPage.statusPending": "Status: Pending",
    "orderSuccessPage.statusCompleted": "Status: Completed",
    "orderSuccessPage.orderDetails": "Order Details",
    "orderSuccessPage.orderDate": "Order Date",
    "orderSuccessPage.orderedItems": "Ordered Items",
  ...
  it: {
    ...
    "checkout.selectPaymentMethod": "Seleziona metodo di pagamento",
    "checkout.orderNotes": "Note sull'Ordine",
    "checkout.orderNotesPlaceholder": "Richieste speciali o note...",
    "checkout.placeOrder": "Conferma Ordine",
    "checkout.processing": "Elaborazione in corso...",
    "checkout.orderTotal": "Totale Ordine",
    ...
    "checkout.invalidPhone": "Numero di telefono non valido",
    "checkout.orderSuccess": "Ordine effettuato con successo!",
    "checkout.orderError": "Errore nell'effettuare l'ordine",
    "checkout.paymentFailed": "Pagamento fallito",
    "checkout.paymentSuccessful": "Pagamento riuscito",
    "checkout.cardNumber": "Numero della Carta",
    "checkout.expiryDate": "Data di Scadenza",
    "checkout.cvv": "CVV",
    "checkout.cardholderName": "Nome del Titolare della Carta",
    "checkout.firstNameRequired": "Il nome è obbligatorio",
    "checkout.lastNameRequired": "Il cognome è obbligatorio",
    "checkout.phoneRequired": "Il numero di telefono è obbligatorio",
    "checkout.addressRequired": "L'indirizzo è obbligatorio",
    ...
    // Order Success Page Stripe translations - Italian
    "orderSuccessPage.title": "Conferma Ordine",
    "orderSuccessPage.loadingOrder": "Caricamento ordine...",
    ...
    "orderSuccessPage.paymentMethodStripe": "Carta di Credito (Stripe)",
    "orderSuccessPage.paymentMethodPaypal": "PayPal",
    "orderSuccessPage.paymentMethodPickup": "Ritiro in Negozio",
    "orderSuccessPage.statusPending": "Stato: In Attesa",
    "orderSuccessPage.statusCompleted": "Stato: Completato",
    "orderSuccessPage.orderDetails": "Dettagli Ordine",
    "orderSuccessPage.orderDate": "Data Ordine",
    "orderSuccessPage.orderedItems": "Articoli Ordinati",
